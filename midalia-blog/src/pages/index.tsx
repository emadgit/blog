  ...
  return (
    <>
      ...
      <main className="h-screen w-screen overflow-auto bg-gradient-to-b from-[#393864] to-[#cf6565]">
        <div className="h-fit sm:h-full" style={{ marginTop: "4px" }}>
            ...
            <div className="bg-slate-0 flex w-3/4 content-center items-center">
              <div className="justify-left mt-24 flex w-full flex-col">
                ...
                <p className="mt-8 flex w-full flex-1 text-center text-xl sm:text-justify">
                  Hi there! I&apos;m Emad Dehnavi, a Senior Software Engineer
                  with a passion for Web & Mobile developments with
                  collaboration, pair programming, and teaching. Here are some
                  of the technologies I&apos;m currently working with:
                </p>
                ...
                <p className="mt-8 flex w-full flex-1 text-center text-xl sm:text-justify">
                  I&apos;m excited to connect with you and discuss how we can
                  build the future together. Feel free to reach out :)
                </p>
